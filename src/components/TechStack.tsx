    ...
    <div className="relative w-full overflow-hidden py-3 sm:py-4 md:py-6 lg:py-10">
      ...
      >
        {items.map((tech, index) => (
          ...
          >
            <h3
              className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-white tracking-tighter hover:text-[#00F0FF] transition-colors duration-300 whitespace-nowrap"
              style={{
