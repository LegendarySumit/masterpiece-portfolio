...
export function DigitalTwinTerminal() {
  ...
  const [history, setHistory] = useState<string[]>([
    '> Initializing Digital Twin: Sumit AI...',
    '> Hello! I am the AI version of Sumit. Type /help to see what I can answer.'
  ]);
  ...
  const handleCommand = (cmd: string) => {
    ...
    switch(cmd.toLowerCase().trim()) {
      case '/help':
        ...
        break;
      case '/contact':
        response = 'Email: prustysumit78@gmail.com | LinkedIn: sumit-kumar-prusty';
        break;
      case '/stack':
      ...
      case '/projects':
        ...
        break;
      case '/hire':
        response = 'Currently open for opportunities! Contact me at prustysumit78@gmail.com.';
        break;
      case '/coffee':
  ...
  return (
    <div className="w-full h-full glass-panel rounded-xl flex flex-col font-mono text-sm overflow-hidden border border-[#00F0FF] shadow-[0_0_40px_rgba(0,240,255,0.2)] bg-[#050505]/90 backdrop-blur-3xl text-left pointer-events-auto">
      ...
      <div className="p-4 bg-[#0a0a0a]/90 flex items-center border-t border-white/10">
        <span className="text-[#B200FF] mr-3 whitespace-nowrap">root@sumit:~#</span>
        <input 
          type="text" 
